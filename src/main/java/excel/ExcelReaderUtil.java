...
public class ExcelReaderUtil {
     ...
     * @param reader      数据解析器
     * @param fileExt     文件扩展名
     * @param filePath    文件路径 与inputStream互斥
     * @param inputStream 数据流与filePath互斥
     * @param sheetId     sheet索引 从1开始(只对07版本有用)
     * @param titleRow    标题行，一般情况下为0 (只对07版本有用)
     * @param dateFormat  日期格式 (只对03版有用)
     * @throws Exception
     */
    public void readExcel(
        ...
        if (fileExt.equals(GlobalContext.EXCEL03_EXTENSION)) {
            // 处理excel2003文件
        ...
        } else if (fileExt.equals(GlobalContext.EXCEL07_EXTENSION)) {
            // 处理excel2007文件
